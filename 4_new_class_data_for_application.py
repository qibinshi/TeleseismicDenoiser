...
with h5py.File(datadir + 'M5_deep500km_SNRmax3_2000_21_sample10_lpass2_P_mpi_both_BH_HH.hdf5', 'w') as f:
    f.create_dataset("pwave", data=allpwave)

meta.to_csv(datadir + "metadata_M5_deep500km_SNRmax3_2000_21_sample10_lpass2_P_mpi_both_BH_HH.csv", sep=',', index=False)
